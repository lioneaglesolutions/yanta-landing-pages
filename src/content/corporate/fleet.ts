...
export const fleet: readonly FleetCategory[] = [
  ...
  },
  {
    ...
    units: [
      ...
      { id: 'YAN049', type: 'Telehandler', description: 'Merlo P72.10 Telehandler.', usage: '1089hrs', availability: 'available', href: '/telehandler-hire', highDemand: true, demandNote: 'Most hire fleets stock 3T — this is a 7T class machine' },
  ...
  },
  {
    ...
    title: 'Poly welding',
    units: [
      { id: 'YPW010', type: 'Poly welder', description: 'Bushranger 630 Track Poly Welder', usage: '2434hrs', availability: 'available', href: '/equipment/bushranger-630', highDemand: true, demandNote: 'Welds to 630mm without waiting on interstate freight' },
